...
object NetworkService {
    ...
    private val client =
        OkHttpClient.Builder().addInterceptor(interceptor).addInterceptor(Authenticator).build()
    private val retrofit = Retrofit.Builder().baseUrl("https://dummyapi.io/").client(client)
